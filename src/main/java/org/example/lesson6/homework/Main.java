...
public class Main {
    public static void main(String[] args) {
        Laptop lap1 = new Laptop("A52556", 1234, "Honor");
        lap1.setColor("black");
        lap1.setHDD(700);
        lap1.setOS("Windows");
        lap1.setRAM(8);

        Laptop lap2 = new Laptop("AC30", 6467, "Lenovo");
        lap2.setColor("white");
        lap2.setHDD(1000);
        lap2.setOS("Windows");
        lap2.setRAM(8);

        Laptop lap3 = new Laptop("CB97", 6701, "Acer");
        lap3.setColor("rose");
        lap3.setHDD(900);
        lap3.setOS("Windows");
        lap3.setRAM(16);

        Laptop lap4 = new Laptop("MN1156", 1111, "hp");
        lap4.setColor("black");
        lap4.setHDD(700);
        lap4.setOS("Linux");
        lap4.setRAM(8);

        Laptop lap5 = new Laptop("MAC111", 4896515, "Apple");
        lap5.setColor("Blue");
        lap5.setHDD(1000);
        lap5.setOS("macOS");
        lap5.setRAM(8);

        Set<Laptop> laptops = new HashSet<>(Arrays.asList(lap1, lap2, lap3, lap4, lap5));
